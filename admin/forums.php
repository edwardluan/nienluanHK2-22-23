							...
							<tbody>
								...
								<tr>
									...
									<td class="text-center">
										<a class="btn btn-sm btn-outline-primary view_forum" href="../index.php?page=view_forum&id=<?php echo $row['id'] ?>" target="_blank" data-id="<?php echo $row['id'] ?>" >Xem thêm</a>
										<button class="btn btn-sm btn-outline-primary edit_forum" type="button" data-id="<?php echo $row['id'] ?>" >Sửa</button>
										<button class="btn btn-sm btn-outline-danger delete_forum" type="button" data-id="<?php echo $row['id'] ?>">Xóa</button>
									</td>
								</tr>
								<?php endwhile; ?>
							</tbody>
