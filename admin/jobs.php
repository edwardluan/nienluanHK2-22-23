			...
			<div class="col-md-12">
				<div class="card">
					<div class="card-header">
						<b>Danh sách cán bộ viên chức</b>
						<span class="">
						...
						<table class="table table-bordered table-condensed table-hover">
							<thead>
								<tr>
									...
									<th class="">Đơn vị công tác</th>
									<th class="">Trình độ</th>
							...
							<tbody>
								...
								<tr>
									...
									<td class="text-center">
										<button class="btn btn-sm btn-outline-primary view_career" type="button" data-id="<?php echo $row['id'] ?>" >Xem thêm</button>
										<button class="btn btn-sm btn-outline-primary edit_career" type="button" data-id="<?php echo $row['id'] ?>" >Sửa</button>
										<button class="btn btn-sm btn-outline-danger delete_career" type="button" data-id="<?php echo $row['id'] ?>">Xóa</button>
									</td>
								</tr>
								<?php endwhile; ?>
							</tbody>
