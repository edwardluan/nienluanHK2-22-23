...
<div class="modal-footer display">
	<div class="row">
		<div class="col-lg-12">
			...
			<?php if($status == 1): ?>
			<button class="btn float-right btn-primary update mr-2" data-status = '0' type="button" data-dismiss="modal">Hủy xác minh tài khoản</button>
			<?php else: ?>
				<button class="btn float-right btn-primary update mr-2" data-status = '1' type="button" data-dismiss="modal">Xác mình tài khoản</button>
			<?php endif; ?>
		</div>
	</div>
</div>
