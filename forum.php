    ...
    <div class="container-fluid h-100">
        <div class="row h-100 align-items-center justify-content-center text-center">
            <div class="col-lg-8 align-self-end mb-4 page-title">
                <h3 class="text-white">Danh sách Diễn đàn</h3>
                ...
                <div class="row col-md-12 mb-2 justify-content-center">
                    <button class="btn btn-primary btn-block col-sm-4" type="button" id="new_forum"><i
                            class="fa fa-plus"></i>Tạo chủ đề mới</button>
                    <script>
                        document.addEventListener("DOMContentLoaded", function () {
                            // Kiểm tra nếu người dùng đã đăng nhập
                            <?php if (isset($_SESSION['login_id'])): ?>
                                // Hiển thị nút "Tạo chủ đề mới"
                                document.getElementById("new_forum").style.display = "block";
                            <?php else: ?>
                                // Ẩn nút "Tạo chủ đề mới"
            ...
            <div class="row">
                <div class="col-md-8">
                    <div class="input-group mb-3">
                        ...
                        <input type="text" class="form-control" id="filter" placeholder="Tìm kiếm" aria-label="Filter"
                            aria-describedby="filter-field">
                    </div>
                </div>
                <div class="col-md-4">
                    <button class="btn btn-primary btn-block btn-sm" id="search">Enter</button>
                </div>
            </div>
                ...
                <div class="row align-items-center justify-content-center text-center h-100">
                    <div class="">
                            ...
                            if ($_SESSION['login_id'] == $row['user_id']):
                                ...
                                <div class="dropdown float-right mr-4">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                        <a class="dropdown-item edit_forum" data-id="<?php echo $row['id'] ?>"
                                            href="javascript:void(0)">Sửa</a>
                                        <a class="dropdown-item delete_forum" data-id="<?php echo $row['id'] ?>"
                        ...
                        <span class="badge badge-info float-left px-3 pt-1 pb-1">
                            <b><i>Chủ đề được tạo bởi: <span class="filter-txt">
                                        <?php echo $row['name'] ?>
                                    </span></i></b>
                        </span>
                        <span class="badge badge-secondary float-left px-3 pt-1 pb-1 ml-2">
                            <b><i class="fa fa-comments"></i> <i>
                                    <?php echo $count_comments ?> Bình luận
                                </i></b>
                        </span>
                        <button class="btn btn-primary float-right view_topic" data-id="<?php echo $row['id'] ?>">Chi
                            tiết</button>
                    </div>
                </div>
            </div>
