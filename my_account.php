                            ...
                            <div class="container-fluid">
                                <div class="col-md-12">
                                    <form action="" id="update_account">
                                        ...
                                        <div class="row form-group">
                                            <div class="col-md-4">
                                                ...
                                                <select class="custom-select" name="gender" required>
                                                    <option <?php echo $_SESSION['bio']['gender'] =='Male' ? 'selected' : '' ?>>Nam</option>
                                                    <option <?php echo $_SESSION['bio']['gender'] =='Female' ? 'selected' : '' ?>>Nữ</option>
                                                </select>
                                            </div>
                                            <div class="col-md-4">
                                                <label for="" class="control-label">Công tác ở trường từ: </label>
                                                <input type="input" class="form-control datepickerY" name="batch" value="<?php echo $_SESSION['bio']['batch'] ?>" required>
                                            </div>
                                            <div class="col-md-4">
                                                <label for="" class="control-label">Ngành tốt nghiệp</label>
                                        ...
                                        <div class="row form-group">
                                            <div class="col-md-5">
                                                <label for="" class="control-label">Đang công tác tại</label>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12 text-center">
                                                <button class="btn btn-primary">Câp nhật</button>
                                            </div>
                                        </div>
                                    </form>
                                </div>
