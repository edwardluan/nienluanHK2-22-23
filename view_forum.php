        ...
        <div class="row h-100 align-items-center justify-content-center text-center">
            ...
            <div class="row col-md-12 mb-2 justify-content-center">
                   <span class="badge badge-primary px-3 pt-1 pb-1">
                        <b><i>Chủ đề được tạo bởi: <?php echo $name ?></i></b>
                    </span>
            </div>   
            </div>
...
<div class="container mt-3 pt-2">
    ...
    <div class="card mb-4">
    	<div class="card-body">
    		<div class="col-lg-12">
    			<div class="row">
    				<h3><b> <i class="fa fa-comments"></i> <?php echo $comments->num_rows ?>Bình luận</b></h3>
    			</div>
    			...
    			<div class="form-group comment">
                    ...
                    <div class="dropdown float-right">
                      ...
                      <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                        <a class="dropdown-item edit_comment" data-id="<?php echo $row['id'] ?>" href="javascript:void(0)">Sửa</a>
                        <a class="dropdown-item delete_comment" data-id="<?php echo $row['id'] ?>" href="javascript:void(0)">Xóa</a>
                      </div>
                    </div>
                    <?php endif; ?>
